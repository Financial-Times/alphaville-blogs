...
const headshots = [{
	name: 'Paul Murphy',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:paul-murphy?source=alphaville&width=144'
}, {
	name: 'Bryce Elder',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:bryce-elder?source=alphaville&width=144'
}, {
	name: 'Cardiff Garcia',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:cardiff-garcia?source=alphaville&width=144'
}, {
	name: 'Dan McCrum',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:dan-mccrum?source=alphaville&width=144'
}, {
	name: 'David Keohane',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:david-keohane?source=alphaville&width=144'
}, {
	name: 'Izabella Kaminska',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:izabella-kaminska?source=alphaville&width=144'
}, {
	name: 'Joseph Cotterill',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:joseph-cotterill?source=alphaville&width=144'
}, {
	name: 'Lisa Pollack',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:lisa-pollack?source=alphaville&width=144'
}, {
	name: 'Matthew C Klein',
	url: 'http://image.webservices.ft.com/v1/images/raw/fthead:matthew-c-klein?source=alphaville&width=144'
}];
...
function getLatestPosts(author, count) {
	return elasticSearch.searchArticles({
		'method': 'POST',
		'body': JSON.stringify({
			query: {
