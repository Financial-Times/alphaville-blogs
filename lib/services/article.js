...
exports.getArticlesByTopic = ((endpoint = 'topic') => (options => getArticles(options, endpoint)))();
exports.getArticlesByAuthor = ((endpoint = 'author') => (options => getArticles(options, endpoint)))();
exports.getMarketsliveArticles = ((endpoint = 'marketslive') => (options => getArticles(options, endpoint)))();
exports.getHotArticles = ((endpoint = 'hotarticles') => (options => getArticles(options, endpoint)))();
exports.getMostReadArticles = ((endpoint = 'most-read') => (options => getArticles(options, endpoint)))();
exports.getMostCommentedArticles = ((endpoint = 'most-commented') => (options => getArticles(options, endpoint)))();
