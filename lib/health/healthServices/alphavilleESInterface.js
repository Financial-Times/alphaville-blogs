...
const healthCheckModel = {
	...
	checkOutput: "",
	panicGuide: `Check the healthcheck of the service (https://${process.env['AV_ELASTIC_SEARCH_URL']}/__health)`,
...
exports.getHealth = function () {
	return new Promise((resolve) => {
		...
		fetch(`${process.env['AV_ES_SERVICE_URL']}/article/4bc7c806-ef50-3c30-9142-d33f411274fd`, {headers: {'X-API-KEY': process.env['AV_ES_SERVICE_KEY']}})
			.then(res => {
				if (res.ok) {
					return res.json();
				} else {
